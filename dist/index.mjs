...
var StepNumber = ({
  ...
  return /* @__PURE__ */ React7.createElement(View6, { style: [styles.stepNumber, containerStyles] }, /* @__PURE__ */ React7.createElement(Text3, { style: [styles.stepNumberText, textStyles] }, currentStepNumber));
};
